...
\end{center}
\textbf{Modelo:} \texttt{draft4\_stationary\_scalar\_validation}\\
\textbf{Run ID:} \texttt{run\_95b885a6f3f8250bbb8c}\\
...
\begin{dmath*}[breakdepth={5}]
L\big|_{\mathrm{ansatz}} = -\left(\frac{2\,f'\!\left(r\right)}{r} + \frac{\alpha\,{\frac{\partial^{1} \Phi}{\partial \varphi^{1}}\!\left(r, \varphi\right)}^{2}}{{r}^{2}} + \alpha\,{\frac{\partial^{1} \Phi}{\partial r^{1}}\!\left(r, \varphi\right)}^{2}\,f\!\left(r\right) + f''\!\left(r\right)\right)
\end{dmath*}
\par\smallskip
...
\begin{dmath*}[breakdepth={5}]
\left[M_{ab}\right]_{11} = -\frac{\left(f'\!\left(r\right) + f''\!\left(r\right)\,r + \alpha\,f\!\left(r\right)\,r\,{\frac{\partial^{1} \Phi}{\partial r^{1}}\!\left(r, \varphi\right)}^{2}\right)}{f\!\left(r\right)\,r}
\end{dmath*}
\par\smallskip
% display: {"assumptions_used": [], "key": "projected.metric_momentum[1,2]", "notes": [], "operations": [], "status": "unchanged"}
\begin{dmath*}[breakdepth={5}]
\left[M_{ab}\right]_{12} = -\alpha\,\frac{\partial^{1} \Phi}{\partial r^{1}}\!\left(r, \varphi\right)\,\frac{\partial^{1} \Phi}{\partial \varphi^{1}}\!\left(r, \varphi\right)
\end{dmath*}
\par\smallskip
% display: {"assumptions_used": [], "key": "projected.metric_momentum[2,1]", "notes": [], "operations": [], "status": "unchanged"}
\begin{dmath*}[breakdepth={5}]
\left[M_{ab}\right]_{21} = -\alpha\,\frac{\partial^{1} \Phi}{\partial r^{1}}\!\left(r, \varphi\right)\,\frac{\partial^{1} \Phi}{\partial \varphi^{1}}\!\left(r, \varphi\right)
\end{dmath*}
\par\smallskip
...
\begin{dmath*}[breakdepth={5}]
\left[M_{ab}\right]_{22} = -\alpha\,{\frac{\partial^{1} \Phi}{\partial \varphi^{1}}\!\left(r, \varphi\right)}^{2} - 2\,r\,f'\!\left(r\right)
\end{dmath*}
\par\smallskip
...
\begin{dmath*}[breakdepth={5}]
\left[J^a\right]^{1} = -2\,\alpha\,\frac{\partial^{1} \Phi}{\partial r^{1}}\!\left(r, \varphi\right)\,f\!\left(r\right)
\end{dmath*}
\par\smallskip
% display: {"assumptions_used": [], "key": "projected.scalar_gradient_momentum[2]", "notes": [], "operations": [], "status": "unchanged"}
\begin{dmath*}[breakdepth={5}]
\left[J^a\right]^{2} = -\frac{2\,\alpha\,\frac{\partial^{1} \Phi}{\partial \varphi^{1}}\!\left(r, \varphi\right)}{{r}^{2}}
\end{dmath*}
\par\smallskip
...
\begin{dmath*}[breakdepth={5}]
\left[E_{ab}\right]_{00} = -\frac{1}{2\,{r}^{2}}\,\left(\alpha\,\left({\frac{\partial^{1} \Phi}{\partial \varphi^{1}}\!\left(r, \varphi\right)}^{2} + {r}^{2}\,{\frac{\partial^{1} \Phi}{\partial r^{1}}\!\left(r, \varphi\right)}^{2}\,f\!\left(r\right)\right) + r\,f'\!\left(r\right)\right)\,f\!\left(r\right)
\end{dmath*}
\par\smallskip
...
\begin{dmath*}[breakdepth={5}]
\left[E_{ab}\right]_{11} = \frac{1}{2\,{r}^{2}\,f\!\left(r\right)}\,\left(r\,f'\!\left(r\right) + \alpha\,\left({\frac{\partial^{1} \Phi}{\partial \varphi^{1}}\!\left(r, \varphi\right)}^{2} - f\!\left(r\right)\,{r}^{2}\,{\frac{\partial^{1} \Phi}{\partial r^{1}}\!\left(r, \varphi\right)}^{2}\right)\right)
\end{dmath*}
\par\smallskip
% display: {"assumptions_used": [], "key": "projected.metric_euler[1,2]", "notes": [], "operations": [], "status": "unchanged"}
\begin{dmath*}[breakdepth={5}]
\left[E_{ab}\right]_{12} = -\alpha\,\frac{\partial^{1} \Phi}{\partial r^{1}}\!\left(r, \varphi\right)\,\frac{\partial^{1} \Phi}{\partial \varphi^{1}}\!\left(r, \varphi\right)
\end{dmath*}
\par\smallskip
% display: {"assumptions_used": [], "key": "projected.metric_euler[2,1]", "notes": [], "operations": [], "status": "unchanged"}
\begin{dmath*}[breakdepth={5}]
\left[E_{ab}\right]_{21} = -\alpha\,\frac{\partial^{1} \Phi}{\partial r^{1}}\!\left(r, \varphi\right)\,\frac{\partial^{1} \Phi}{\partial \varphi^{1}}\!\left(r, \varphi\right)
\end{dmath*}
\par\smallskip
% display: {"assumptions_used": [], "key": "projected.metric_euler[2,2]", "notes": [], "operations": [], "status": "unchanged"}
\begin{dmath*}[breakdepth={5}]
\left[E_{ab}\right]_{22} = \frac{1}{2}\,\left({r}^{2}\,f''\!\left(r\right) - \alpha\,{\frac{\partial^{1} \Phi}{\partial \varphi^{1}}\!\left(r, \varphi\right)}^{2} + \alpha\,{r}^{2}\,{\frac{\partial^{1} \Phi}{\partial r^{1}}\!\left(r, \varphi\right)}^{2}\,f\!\left(r\right)\right)
\end{dmath*}
\par\smallskip
...
\begin{dmath*}[breakdepth={5}]
L=-\left(\frac{2\,f'\!\left(r\right)}{r} + \alpha\,{\Phi'\!\left(r\right)}^{2}\,f\!\left(r\right) + f''\!\left(r\right)\right)
\end{dmath*}
...
\begin{dmath*}[breakdepth={5}]
L=-\left(\frac{2\,f'\!\left(r\right)}{r} + \frac{\alpha\,{\Phi'\!\left(\varphi\right)}^{2}}{{r}^{2}} + f''\!\left(r\right)\right)
\end{dmath*}
Componentes independientes no nulas; $P^{abcd}=-P^{bacd}=-P^{abdc}=P^{cdab}$.
\begin{dmath*}[breakdepth={5}]
\left[P^{abcd}\right]^{0101}=-\frac{1}{2}
