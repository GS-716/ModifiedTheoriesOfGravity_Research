"""Ejecuta y conserva la validación Noether-Wald de fase 6."""
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Valida difeomorfismos, corriente de Noether y carga de Wald con xAct."
    )
    parser.add_argument(
        "--output",
        type=Path,
        default=PROJECT_ROOT / "outputs" / "phase6_wolfram_validation.json",
    )
    ...
    print(
        f"Wolfram/xAct fase 6: {report.status}; "
