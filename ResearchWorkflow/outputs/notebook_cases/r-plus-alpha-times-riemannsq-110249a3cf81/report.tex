...
\end{center}
\textbf{Modelo:} \texttt{R\_plus\_alpha\_times\_RiemannSq}\\
\textbf{Run ID:} \texttt{run\_110249a3cf81929ef584}\\
...
\begin{dmath*}[breakdepth={5}]
L=-f''\!\left(r\right) + \alpha\,{f''\!\left(r\right)}^{2} - \frac{2\,f'\!\left(r\right)}{r} + \frac{2\,\alpha\,{f'\!\left(r\right)}^{2}}{{r}^{2}}
\end{dmath*}
