...
\end{center}
\textbf{Modelo:} \texttt{case\_07\_R\_plus\_RiemannGrad4}\\
\textbf{Run ID:} \texttt{run\_4da30f66c796b55e8c29}\\
...
\textbf{Deltas canónicos:} 1642 sustituciones y 0 trazas registradas en las pasadas del álgebra (incluidas verificaciones); 0 deltas explícitos en las 13 cantidades finales. Detalle e índices sustituidos en \texttt{delta\_contractions.json}.\par
...
L = R{}_{d_{0}\,d_{1}\,d_{2}\,d_{3}}\,g{}^{d_{0}\,d_{2}}\,g{}^{d_{1}\,d_{3}} + R{}_{d_{0}\,d_{1}\,d_{2}\,d_{3}}\,g{}^{d_{0}\,d_{4}}\,g{}^{d_{1}\,d_{5}}\,g{}^{d_{2}\,d_{6}}\,g{}^{d_{3}\,d_{7}}\,u{}_{d_{4}}\,u{}_{d_{5}}\,u{}_{d_{6}}\,u{}_{d_{7}}\,\alpha
\end{dmath*}
...
\begin{dmath*}[breakdepth={5}]
E_{ab} = -\frac{g{}_{a\,b}\,R{}_{d_{0}\,d_{1}}{}^{d_{0}\,d_{1}}}{2} - \frac{g{}_{a\,b}\,u{}_{d_{0}}\,R{}^{d_{0}\,d_{1}\,d_{2}\,d_{3}}\,u{}_{d_{1}}\,u{}_{d_{2}}\,u{}_{d_{3}}\,\alpha}{2} + R{}_{a\,d_{0}\,b}{}^{d_{0}}
\end{dmath*}
\par\vspace{1.2\baselineskip}\noindent
\begin{minipage}{\linewidth}
...
\begin{dmath*}[breakdepth={5}]
\text{forma compacta:}\quad E_{ab} = -\frac{g{}_{a\,b}\,R{}_{d_{0}\,d_{1}}{}^{d_{0}\,d_{1}}}{2} - \frac{g{}_{a\,b}\,u{}_{d_{0}}\,R{}^{d_{0}\,d_{1}\,d_{2}\,d_{3}}\,u{}_{d_{1}}\,u{}_{d_{2}}\,u{}_{d_{3}}\,\alpha}{2} + R{}_{a\,d_{0}\,b}{}^{d_{0}}
\end{dmath*}
...
\begin{dmath*}[breakdepth={5}]
\text{forma compacta:}\quad -\frac{1}{2}g_{ab}L = -\frac{1}{2}\,g{}_{a\,b}\,\left(R{}_{d_{0}\,d_{1}\,d_{2}\,d_{3}}\,g{}^{d_{0}\,d_{2}}\,g{}^{d_{1}\,d_{3}} + R{}_{d_{0}\,d_{1}\,d_{2}\,d_{3}}\,g{}^{d_{0}\,d_{4}}\,g{}^{d_{1}\,d_{5}}\,g{}^{d_{2}\,d_{6}}\,g{}^{d_{3}\,d_{7}}\,u{}_{d_{4}}\,u{}_{d_{5}}\,u{}_{d_{6}}\,u{}_{d_{7}}\,\alpha\right)
\end{dmath*}
