...
\textbf{Modelo:} R\_plus\_alpha\_times\_RicciUU\par
\[\adjustbox{max width=\linewidth}{$\displaystyle \text{Lagrangiano:}\qquad L=g{}^{a\,c}\,g{}^{b\,d}\,R{}_{a\,b\,c\,d} + \alpha\,g{}^{a\,c}\,R{}_{a\,b\,c\,d}\,g{}^{b\,e}\,g{}^{d\,f}\,u{}_{e}\,u{}_{f}$}\]
...
\[\adjustbox{max width=\linewidth}{$\displaystyle E^{\tau}_{\tau}-E^{r}_{r}=\frac{2\,\alpha\,{q}^{2}\,f\!\left(r\right)}{{r}^{4}}=0$}\]
\[\adjustbox{max width=\linewidth}{$\displaystyle E^{\tau}_{\tau}-E^{\varphi}_{\varphi}=\frac{\left(f'\!\left(r\right)\,{r}^{3} - f''\!\left(r\right)\,{r}^{4} + 4\,\alpha\,{q}^{2}\,\left(-f\!\left(r\right) + r\,f'\!\left(r\right)\right)\right)}{2\,{r}^{4}}=0$}\]
\[\adjustbox{max width=\linewidth}{$\displaystyle E^{r}_{r}-E^{\varphi}_{\varphi}=\frac{\left(f'\!\left(r\right)\,{r}^{3} - f''\!\left(r\right)\,{r}^{4} + 4\,\alpha\,{q}^{2}\,\left(-2\,f\!\left(r\right) + r\,f'\!\left(r\right)\right)\right)}{2\,{r}^{4}}=0$}\]
\section*{Ecuaciones absolutas y escalares}
\[\adjustbox{max width=\linewidth}{$\displaystyle E^{\tau}_{\tau}=\frac{\left({r}^{3}\,f'\!\left(r\right) + 2\,\alpha\,{q}^{2}\,f\!\left(r\right)\right)}{2\,{r}^{4}}=0$}\]
...
Salida formal conservada en Wolfram: BesselI[0, ("alpha"*"q"\textasciicircum{}2)/"r"\textasciicircum{}2]\par
